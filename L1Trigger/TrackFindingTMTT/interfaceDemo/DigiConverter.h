...
class DigiConverter {
  public:
    ...
    DigiHTMiniStub makeDigiHTMiniStub( const TMTT::Stub& aHTMiniStub, const TMTT::L1track3D& a3DTrk, bool isFirstStubOnTrackCandidate, uint32_t aSectorId, int8_t cBin, int8_t mBin) const;

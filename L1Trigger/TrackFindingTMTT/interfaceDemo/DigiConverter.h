...
class DigiConverter {
  public:
    ...
    DigiHTMiniStub makeDigiHTMiniStub( const TMTT::Stub& aHTMiniStub, const TMTT::L1track2D& aFitTrk, bool isFirstStubOnTrackCandidate, uint32_t aSectorId, int8_t cBin, int8_t mBin) const;
